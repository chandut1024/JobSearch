...
WebUI.setText(findTestObject('UserName'), findTestData('LoginDetailsNJS').getValue(2, 3))

WebUI.click(findTestObject('NextButton'))

WebUI.delay(5)

WebUI.setText(findTestObject('Password'), findTestData('LoginDetailsNJS').getValue(3, 3))
...
WebUI.uploadFile(findTestObject('UploadResumeButton'), findTestData('LoginDetailsNJS').getValue(5, 3))
